...
export default function PulsePage() {
  ...
  return (
    <div className="space-y-6 p-6">
      <header>
        <h1 className="text-2xl font-bold tracking-tight text-lykia-200">Ekip Nabız</h1>
        <p className="mt-1 text-sm text-slate-400">Personel anketi.</p>
      </header>
