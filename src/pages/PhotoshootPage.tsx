...
export default function PhotoshootPage() {
  ...
  async function refresh() {
    try {
      const data = await fetchPhotoshoot()
      setRows(data.photoshoot || [])
      setError(null)
  ...
  async function onCreate(e: FormEvent) {
    ...
    try {
      ...
      await createPhotoshoot(payload)
      await refresh()
  ...
  return (
    <div className="space-y-6 p-6">
      <header>
        <h1 className="text-2xl font-bold tracking-tight text-lykia-200">Fotoğraf Çekim</h1>
